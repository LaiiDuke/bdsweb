...
!(function (t, e) {
    ...
    nt = (function (t) {
      ...
      return (
        ...
        (e.collapseInterface = function (t, n) {
          ...
          if (
            (!i && o.toggle && 'string' == typeof n && /show|hide/.test(n) && (o.toggle = !1), i || (i = new e(t, o)), 'string' == typeof n)
          ) {
      ...
      return (
        ...
        (i.dataApiKeydownHandler = function (t) {
          if (
            ...
            if ('Escape' === t.key)
              return (
                (this.matches('[data-bs-toggle="dropdown"]') ? this : $(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
                void i.clearMenus()
              );
        ...
        (a.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            if (!n.defaultPrevented && o) {
              ...
              var a =
                  'function' == typeof this.config.placement ? this.config.placement.call(this, s, this._element) : this.config.placement,
          ...
          if (null !== t)
            return 'object' == typeof e && g(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize && (e = bt(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e))
                  : (t.textContent = e));
        }),
        (a.getTitle = function () {
      ...
      return (
        (n.show = function () {
          ...
          if (!K.trigger(this._element, 'show.bs.toast').defaultPrevented) {
            ...
            if (
              (this._element.classList.remove('hide'), y(this._element), this._element.classList.add('showing'), this._config.animation)
            ) {
  ...
  return (
    T('toast', Mt),
    { Alert: U, Button: F, Carousel: J, Collapse: nt, Dropdown: dt, Modal: gt, Popover: Ot, ScrollSpy: Pt, Tab: xt, Toast: Mt, Tooltip: Lt }
  );
});
