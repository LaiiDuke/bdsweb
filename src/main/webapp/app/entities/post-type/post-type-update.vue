        ...
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              id="post-type-name"
              data-cy="name"
              :class="{ valid: !$v.postType.name.$invalid, invalid: $v.postType.name.$invalid }"
              v-model="$v.postType.name.$model"
              required
            />
...
<script lang="ts" src="./post-type-update.component.ts"></script>
