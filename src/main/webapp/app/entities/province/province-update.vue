  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="bdswebApp.province.home.createOrEditLabel"
          data-cy="ProvinceCreateUpdateHeading"
          v-text="$t('bdswebApp.province.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('bdswebApp.province.name')" for="province-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
              ...
              required
            />
            <div v-if="$v.province.name.$anyDirty && $v.province.name.$invalid">
              <small class="form-text text-danger" v-if="!$v.province.name.required" v-text="$t('entity.validation.required')">
