    ...
    <div class="recent-listing">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="owl-carousel owl-listing" :key="isFetching">
              <post-slide-component v-for="index in numberOfSlide" :key="index" :lst-post="vipPost" :index="index"></post-slide-component>
...
import PostSlideComponent from '@/component/postSlide/postSlide.vue';
