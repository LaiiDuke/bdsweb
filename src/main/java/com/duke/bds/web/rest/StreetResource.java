...
import com.duke.bds.service.StreetQueryService;
...
/**
 * REST controller for managing {@link com.duke.bds.domain.Street}.
 */
@RestController
@RequestMapping("/api")
public class StreetResource {
    ...
    public StreetResource(StreetService streetService, StreetRepository streetRepository, StreetQueryService streetQueryService) {
    ...
    public ResponseEntity<StreetDTO> partialUpdateStreet(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, streetDTO.getId().toString())
        );
    }
